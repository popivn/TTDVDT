...
# Đặt WORKDIR phù hợp với Render
WORKDIR /app/ClientApp/TTDVDTTNCXHClient
...
COPY ClientApp/TTDVDTTNCXHClient/package*.json ./
...
COPY ClientApp/TTDVDTTNCXHClient/ ./
...
# Angular 20+ output: dist/TTDVDTTNCXHClient/browser
COPY --from=angular-build /app/ClientApp/TTDVDTTNCXHClient/dist/TTDVDTTNCXHClient/browser ./wwwroot
